...
public final class simpleBotConstants {
    ...
    //Speeds:
    public static double FLYWHEEL_SPEED = .7565;  //Volkswagen Mode = .7
    public static double FLYWHEEL_POWERSHOT_SPEED = .636;
    public static double FLYWHEEL_LONGSHOT_SPEED = .69;
    ...
    public static final double BLOCKER_LEFT_START = .16;
